...
let evolutionSpeed = 300;// One second between generations
...
function setPrevGen() {
  ...
  const index = history.length - 1 + historyPointer

  currGen = JSON.parse(JSON.stringify(history[index]))
  updateWorld()
...
function createNextGen() {
  ...
  history.push(JSON.parse(JSON.stringify(currGen)))
}
